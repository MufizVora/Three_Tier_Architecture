...
public class SliderFileUpload
{
    private readonly IWebHostEnvironment _webHostEnvironment;

    public SliderFileUpload(IWebHostEnvironment webHostEnvironment)
    {
    ...
    public async Task<string> UploadProductFile(IFormFile file)
    {
        ...
        string uploadsFolder = Path.Combine(_webHostEnvironment.WebRootPath, "slideruploads");
